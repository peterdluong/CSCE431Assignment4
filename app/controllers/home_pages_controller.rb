class HomePagesController < ApplicationController
  before_action :set_home_page, only: [:show, :edit, :delete, :update, :destroy]
  ...
  def create
    ...
    respond_to do |format|
      if @home_page.save
        format.html { redirect_to home_pages_path, notice: 'Book was successfully added to book table.' }
  ...
  def update
    respond_to do |format|
      if @home_page.update(home_page_params)
        format.html { redirect_to @home_page, notice: 'Book details was successfully updated.' }
  ...
  def destroy
    @home_page.destroy
    respond_to do |format|
      format.html { redirect_to home_pages_url, notice: 'Book was successfully deleted from book table.' }
  ...
  private
    ...
    def home_page_params
      params.require(:home_page).permit(:title, :author, :genre, :price, :publishedDate)
    end
end

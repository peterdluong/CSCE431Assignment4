...
class HomePagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home_page" do
    assert_difference('HomePage.count') do
      post home_pages_url, params: { home_page: { author: @home_page.author, genre: @home_page.genre, price: @home_page.price, publishedDate: @home_page.publishedDate, title: @home_page.title } }
    end
  ...
  test "should update home_page" do
    patch home_page_url(@home_page), params: { home_page: { author: @home_page.author, genre: @home_page.genre, price: @home_page.price, publishedDate: @home_page.publishedDate, title: @home_page.title } }
